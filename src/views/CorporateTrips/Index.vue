        ...
        <table class="min-w-full leading-normal">
          ...
          <tbody class="relative" v-if="rides.length">
            <tr v-for="trip in rides" :key="trip._id">
              ...
              <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <div>
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <span>{{
                      trip.dropOffAddress ? trip.dropOffAddress.name : "-"
                    }}</span>
                  </div>
                </div>
              </td>
              ...
              <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <p class="text-gray-900 whitespace-no-wrap">
                  {{ trip.vehicleType ? trip.vehicleType.name : "-" }}
                </p>
              </td>
              <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <p class="text-gray-900 whitespace-no-wrap">
...
export default {
  ...
  this.selectedDriverObj = null;
    ...
    getRides() {
      this.loading = true;
      var path = `corporates/${this.corporateId}/trips?limit=${this.perPage}&page=${this.currentPage}&populate=["driver","passenger","vehicleType","dispatcher"]`;
