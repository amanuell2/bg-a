<template>
  <div>
    <div class="space-y-4">
      <div>
        <h2 class="font-semibold text-gray-600 uppercase">Promo History</h2>
      </div>
      ...
      <div class="inline-block min-w-full mt-4 rounded-lg shadow">
        <table class="min-w-full leading-normal">
          ...
          <tbody class="relative" v-if="promos.length">
            <tr v-for="(promo) in promos" :key="promo._id">
              <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <p class="text-gray-900 whitespace-no-wrap">
                  {{
                    promo.passenger
                      ? promo.passenger.firstName + " " + promo.passenger.lastName
                      : "-"
                  }}
                </p>
              </td>
              <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <p class="text-gray-900 whitespace-no-wrap">
                  {{
                    promo.driver
                      ? promo.driver.firstName + " " + promo.driver.lastName
                      : "-"
                  }}
                </p>
              </td>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="py-1">
                          <router-link
                            :to="`promos-inventory/${promoPrize._id}/edit`"
            ...
            <tr>
              ...
              >
                ...
                <div v-else class="inline-block">
                  ...
                  <span class="block">No latest promos!</span>
                </div>
              </td>
            </tr>
          </tbody>
...
export default {
  ...
  methods: {
    ...
    getTripRequests() {
      this.loading = true;
      var path = `promos?limit=${this.perPage}&page=${this.currentPage}`;
