<template>
  <div>
    <div class="space-y-4">
      <div>
        <h2 class="font-semibold text-gray-600 uppercase">Passenger Leaderboard</h2>
      </div>
          ...
          <div class="flex">
            ...
            <div class="px-4">
              ...
              >
                ...
                <option
                  :selected="selectedFilter === 'roadPickup'"
                  value="roadPickup"
                >
                  Road pickup
                </option>
                ...
                <option
                  :selected="selectedFilter === 'corporate'"
                  value="corporate"
                >
                  Corporate
                </option>
                <option
                  :selected="selectedFilter === 'bid'"
                  value="bid"
                >
                  Bid
                </option>
...
export default {
  ...
  methods: {
    ...
    getLeaderBoard() {
      this.loading = true;
      var path = `passenger-leaderboard?limit=${this.perPage}&page=${this.currentPage}&type=${this.selectedFilter}`;
