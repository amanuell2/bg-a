          ...
          <tbody class="relative" v-if="tripSearches.length">
            ...
            >
              ...
              >
                ...
                >
                  <a
                    :href="`/corporate/trip-requests?tripSearch=${tripSearch._id}`"
                    target="self"
...
export default {
  ...
  computed: {
    ...
    reportDownloadUrl() {
      return (
        `corporates/${this.corporateId}/trip-searches/export?` +
        Object.entries({
          ...Object.fromEntries(
            Object.entries({
  ...
  methods: {
    ...
    cancelTripSearch(request) {
      if (request) {
        this.$http
          .post(`corporates/${this.corporateId}/trip-searches/${request}/cancel`)
          .then(() => {
            window.flash({
              type: "success",
    ...
    retryTripSearch(request) {
      if (request) {
        this.$http
          .post(`corporates/${this.corporateId}/trip-searches/${request}/retry`)
          .then(() => {
            window.flash({
              type: "success",
    ...
    restartTripSearch(request) {
      if (request) {
        this.$http
          .post(`corporates/${this.corporateId}/trip-searches/${request}/restart`)
          .then(() => {
            window.flash({
              type: "success",
    ...
    getTripSearches() {
      this.loading = true;
      var path = `corporates/${this.corporateId}/trip-searches?limit=${this.perPage}&page=${this.currentPage}&populate=["driver","passenger","vehicleType","dispatcher"]`;
